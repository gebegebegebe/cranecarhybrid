...
#define E2 6  // Enable Pin for motor 2 11
#define I1 11  // Control pin 1 for motor 1 9 
#define I2 10  // Control pin 2 for motor 1 6
...
void setup() {
    ...
    pinMode(I3, OUTPUT);
    pinMode(I4, OUTPUT);
    myservo1.attach(15); // attach servo signal wire to pin 9
  myservo2.attach(16);
  myservo3.attach(17);
  myservo4.attach(18);
