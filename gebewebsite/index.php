...
<head>
	<title>WELCOME TO GABS' DOMAIN</title>
			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="17457.jpg" class="brand_logo" alt="Logo">
					</div>
				</div>
				...
				$_SESSION['message'] = NULL; //Delete Message
				}
				if(isset($_SESSION['logged']) && $_SESSION['logged'] == TRUE) {
				//This part wil display User Information
				echo '
				<h3>You are logged in!</h3>
				<p>Last Login: '.$_SESSION['lastlogin'].'</p>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have an account? <a href="new.php" class="ml-2">Sign Up</a>
					</div>
					<div class="d-flex justify-content-center links">
